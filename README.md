...
* **[SCGraphTheory](https://github.com/sdcondon?tab=repositories&q=SCGraphTheory):** There are myriad graph theory implementations out there for .NET. This one has a dedicated simple abstraction package, making it easy to create/use graph and algorithm implementations independently of one another.
